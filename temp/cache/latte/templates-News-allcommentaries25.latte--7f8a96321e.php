<?php
// source: C:\xampp\htdocs\blog-hassio\app\presenters/templates/News/allcommentaries25.latte

use Latte\Runtime as LR;

class Template7f8a96321e extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
                <blockquote>
                    <h4><?php echo LR\Filters::escapeHtmlText($comment->ref('users','user_id')->username) /* line 11 */ ?></a> | <a href="<?php
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("News:view", [$comment->news_id])) ?>"><?php
