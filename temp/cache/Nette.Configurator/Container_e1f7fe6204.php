...
class Container_e1f7fe6204 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\www\novinky\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\www\novinky\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\www\novinky\app/../temp/cache',
	...
	{
		return new Container_e1f7fe6204_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_e1f7fe6204_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e1f7fe6204 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\www\novinky\app/../temp/cache/latte');
