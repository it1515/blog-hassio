...
class Container_e7d7184031 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function createService__28_App_Model_NewsManager(): App\Model\NewsManager
	{
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_e7d7184031 $container)
			{
