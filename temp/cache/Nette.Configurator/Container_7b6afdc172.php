<?php
// source: D:\www\blog-hassio\app/config/config.neon 
// source: D:\www\blog-hassio\app/config/config.local.neon 

class Container_7b6afdc172 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\www\blog-hassio\app',
			'wwwDir' => 'D:\www\blog-hassio\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'D:\www\blog-hassio\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\www\blog-hassio\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\www\blog-hassio\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\www\blog-hassio\app/../temp/cache',
	...
	{
		return new Container_7b6afdc172_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_7b6afdc172_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_7b6afdc172 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\www\blog-hassio\app/../temp/cache/latte');
